  ...
  static projects = [
    {
      ...
      rows: [
        [
          new TextNode(
            'That One Spot is a rebrand I did for a client running a family owned burger ' +
            'restaurant located in Ocoee, FL. They are known for their well crafted and ' +
            'customizable burgers with a variety of meat options but also provide a variety ' +
            'of salads and sides. While their ingredients are fresh and local they aim to be ' +
            'a fast casual spot for everyone to grab a bite. Keeping their brand in mind I ' +
            'was hired to rebrand the restaurant to more closely reflect their voice today ' +
            'and as they look to grow.',
            'TLDR'),
          new ImageNode(
            'images/spot-all.jpg',
            2,
    ...
    },
    {
      ...
      rows: [
        [
          new TextNode(
            'EyeSpy is a project I did with my classmate, Paige Carl, for the ' +
            'Harn Museum of Art in Gainesville, FL. The project challenge was ' +
            'to design an app for the Harn Museum that focused on the Asian ' +
            'collection emphasizing both mobility and sensor technology. Our ' +
            'solution led to the creation of an app, EyeSpy, which we prototyped ' +
            'with a focus on the Asian collection of the Harn but could also be ' +
            'expanded for future collections. <br><br> EyeSpy is designed to be ' +
            'the Harn Museum’s interactive mystery adventure game app. Users have ' +
            'only 60 minutes to physically explore the museum exhibit to search ' +
            'for clues and figure out riddles to solve the mystery. During the project ' +
            'I had a large focus on the story, concepting, research, User Interface design, ' +
            'and illustration. Paige and I worked together to create the information ' +
            'architecture and user experience of the game and split screen production design. ' +
            '<br><br> Try the prototype on <a href="http://invis.io/UX2RU5KV6" target="_blank">invision</a>'
          ),
    ...
    },
    {
      ...
      rows: [
        [
          new TextNode(
            'The marketing team for Recreational Sports at the University ' +
            'of Florida is comprised of designers, videographers, photographers, ' +
            'and media specialists. I work in-house where we service many different ' +
            'departments within RecSports like clients making sure to boost ' +
            'visibility and spread awareness of several campaigns or events. ' +
            'This was a 4 page booklet I designed for Small Group Training. It ' +
            'includes the different formats offered for that semester as well ' +
            'as the rates and calendar of all the classes being offered. For the ' +
            'campagn we printed and distributed the 4 pager at all our facilities ' +
            'and ran the campaign through our website and social media channels. I ' +
            'also animated the campaign for our digital outlets that play throughout ' +
            'the day on severals screens throughout the fitness facilites.',
            'TLDR'),
          new VideoNode(
    ...
    },
    {
      ...
      rows: [
        [
          new TextNode(
            'Relient K - Only Fools Know Everything was a retrospective tour ' +
            'campaign I created for a student project. For this retrospective tour ' +
            'I wanted to capture the essence of growing up and making mistakes but ' +
            'having fun doing it which is how the band has characterized themselves ' +
            'through their music over the years. The idea is that because you were ' +
            'a fool you messed up and it has made you who you are today. <br><br>The ' +
            'tour is accompanied by a book release in which the band writes on their ' +
            'journey and process of writing their songs as well as a special edition ' +
            'CD release that includes a lyric booklet of all the songs on the album. ' +
            'Fans and new listeners will notice that each song is accompanied by ' +
            'illustrations relating to lyrics within the songs. These illustrations ' +
            'comprise the identity of the tour itself shown through posters, VIP ' +
            'passes, book and album art. '
          ),
          new ImageNode(
    ...
    },
    {
      ...
      rows: [
        [
          new TextNode(
            'The Kailune Chronicles is a project designed for the Disney ' +
            'Imaginations Competition. I recruited 3 other students - ' +
            'Elizabeth Rhodes, Brandon Kocher, and Shari Brown. The 2015 ' +
            'challenge was to create a form of traveling entertainment ' +
            'that could be set up and broken down within a day. Together ' +
            'we collaborated and came up with the story of the Kailune ' +
            'Chronicles. In production we split up our duties to create ' +
            'the final presentation. My contributions to the project were ' +
            'creating the logo, the official park map, helping with concept ' +
            'and UX of the app, concept art of the domes and airships, ' +
            'research of airship technology, Maya 3-D model of the airships, ' +
            'and the storyboard art sequence of the final show. Overall I ' +
            'worked as the team leader and art director making calendars and ' +
            'controlling task management of the group.'
          ),
          new ImageNode(
    ...
    },
    {
      ...
      clips: [
        '<iframe src="https://player.vimeo.com/video/157179695" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'
      ],
      images: [
        '$',
